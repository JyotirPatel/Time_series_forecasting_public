...
from ts_forecasting.sequential import CausalHistoryTransformer, IdentityTransformer
...
RIDGE_OOFNORM_PENTASLICE_H13_S008_Q85_A50_UNWEIGHTED_V1_CONFIG: dict[str, object] = {
    "regressor": "normalized_prefix_residual",
    "base_predictor": RECENT_DELTA_K7_H13_PENTASLICE_H3_BETA_UP_V1_CONFIG,
    "model_type": "ridge",
    "horizons": [1, 3],
    "sub_categories": ["DPPUO5X2", "PZ9S1Z4V", "PHHHVYZI", "NQ58FVQM", "V8BKY1IV"],
    "residual_train_steps": 720,
    "oof_holdout_steps": 360,
    "oof_step_size": 360,
    "oof_min_train_steps": 2000,
...
HUBER_OOFNORM_PENTASLICE_H13_S008_Q85_A1_EPS135_I200_V1_CONFIG: dict[str, object] = {
    "regressor": "normalized_prefix_residual",
    "base_predictor": RIDGE_OOFNORM_PENTASLICE_H13_S008_Q85_A50_UNWEIGHTED_V1_CONFIG,
    "model_type": "huber",
    "horizons": [1, 3],
    "sub_categories": ["DPPUO5X2", "PZ9S1Z4V", "PHHHVYZI", "NQ58FVQM", "V8BKY1IV"],
    "residual_train_steps": 720,
...
HISTGBM_OOFNORM_PENTASLICE_H13_S008_Q85_LR005_MD6_I200_LEAF200_V1_CONFIG: dict[str, object] = {
    "regressor": "normalized_prefix_residual",
    "base_predictor": RIDGE_OOFNORM_PENTASLICE_H13_S008_Q85_A50_UNWEIGHTED_V1_CONFIG,
    "model_type": "hist_gbm",
    "horizons": [1, 3],
...
HISTGBM_OOFNORM_PENTASLICE_H13_S008_Q85_LR005_MD6_I200_LEAF200_CAUSAL_HISTORY_V1_CONFIG: dict[
    str, object
] = {
    **HISTGBM_OOFNORM_PENTASLICE_H13_S008_Q85_LR005_MD6_I200_LEAF200_V1_CONFIG,
    "transformer": {
        "type": "causal_history",
...
HUBER_OOFNORM_ALLSUB_H25_S005_Q80_A1_EPS135_I200_V1_CONFIG: dict[str, object] = {
    "regressor": "normalized_prefix_residual",
    "base_predictor": RIDGE_OOFNORM_PENTASLICE_H13_S008_Q85_A50_UNWEIGHTED_V1_CONFIG,
    "model_type": "huber",
    "horizons": [25],
...
HUBER_OOFNORM_ALLSUB_H25_S005_Q80_A1_EPS135_I200_CAUSAL_LAST_V1_CONFIG: dict[str, object] = {
    **HUBER_OOFNORM_ALLSUB_H25_S005_Q80_A1_EPS135_I200_V1_CONFIG,
    "transformer": {
        "type": "causal_history",
        "level_columns": ["code", "sub_category", "horizon"],
...
HISTGBM_OOFNORM_ALLSUB_H25_S005_Q80_LR005_MD6_I200_LEAF200_V1_CONFIG: dict[str, object] = {
    "regressor": "normalized_prefix_residual",
    "base_predictor": RIDGE_OOFNORM_PENTASLICE_H13_S008_Q85_A50_UNWEIGHTED_V1_CONFIG,
    "model_type": "hist_gbm",
    "horizons": [25],
...
HISTGBM_OOFNORM_ALLSUB_H25_S005_Q80_LR005_MD6_I200_LEAF200_CAUSAL_LAST_V1_CONFIG: dict[
    str, object
] = {
    **HISTGBM_OOFNORM_ALLSUB_H25_S005_Q80_LR005_MD6_I200_LEAF200_V1_CONFIG,
    "transformer": {
        "type": "causal_history",
        "level_columns": ["code", "sub_category", "horizon"],
        "history_features": ["last"],
...
WINNER_LONGWATCH_RESIDUAL_RAW_V1_CONFIG: dict[str, object] = {
    "regressor": "fixed_prefix_residual",
    "base_predictor": RIDGE_OOFNORM_PENTASLICE_H13_S008_Q85_A50_UNWEIGHTED_V1_CONFIG,
    "model_type": "ridge",
...
WINNER_PLUS_LONGWATCH_EXPERT_BLEND_V1_CONFIG: dict[str, object] = {
    "regressor": "conditional_linear_blend",
    "default_predictor": RIDGE_OOFNORM_PENTASLICE_H13_S008_Q85_A50_UNWEIGHTED_V1_CONFIG,
    "slice_predictor": WINNER_LONGWATCH_RESIDUAL_RAW_V1_CONFIG,
    "blend_rules": [
...
BASELINE_CONFIGS: dict[str, dict[str, object]] = {
    ...
    "ridge_oofnorm_pentaslice_h13_s008_q85_a50_unweighted_v1": {
        **RIDGE_OOFNORM_PENTASLICE_H13_S008_Q85_A50_UNWEIGHTED_V1_CONFIG,
        "run_by_default": False,
    },
    "huber_oofnorm_pentaslice_h13_s008_q85_a1_eps135_i200_v1": {
        **HUBER_OOFNORM_PENTASLICE_H13_S008_Q85_A1_EPS135_I200_V1_CONFIG,
        "run_by_default": False,
    },
    ...
    "histgbm_oofnorm_pentaslice_h13_s008_q85_lr005_md6_i200_leaf200_causal_history_v1": {
        **HISTGBM_OOFNORM_PENTASLICE_H13_S008_Q85_LR005_MD6_I200_LEAF200_CAUSAL_HISTORY_V1_CONFIG,
        "run_by_default": False,
    },
    "huber_oofnorm_allsub_h25_s005_q80_a1_eps135_i200_v1": {
        **HUBER_OOFNORM_ALLSUB_H25_S005_Q80_A1_EPS135_I200_V1_CONFIG,
        "run_by_default": False,
    },
    "huber_oofnorm_allsub_h25_s005_q80_a1_eps135_i200_causal_last_v1": {
        **HUBER_OOFNORM_ALLSUB_H25_S005_Q80_A1_EPS135_I200_CAUSAL_LAST_V1_CONFIG,
        "run_by_default": False,
    },
    "histgbm_oofnorm_allsub_h25_s005_q80_lr005_md6_i200_leaf200_v1": {
        **HISTGBM_OOFNORM_ALLSUB_H25_S005_Q80_LR005_MD6_I200_LEAF200_V1_CONFIG,
        "run_by_default": False,
    },
    "histgbm_oofnorm_allsub_h25_s005_q80_lr005_md6_i200_leaf200_causal_last_v1": {
        **HISTGBM_OOFNORM_ALLSUB_H25_S005_Q80_LR005_MD6_I200_LEAF200_CAUSAL_LAST_V1_CONFIG,
        "run_by_default": False,
    },
    "winner_longwatch_residual_raw_v1": {
        **WINNER_LONGWATCH_RESIDUAL_RAW_V1_CONFIG,
        "run_by_default": False,
    },
    "winner_plus_longwatch_expert_blend_v1": {
        **WINNER_PLUS_LONGWATCH_EXPERT_BLEND_V1_CONFIG,
        "run_by_default": False,
    },
...
def _resolve_extra_columns(
    ...
    *,
    ...
    if regressor_type in {"group_mean", "smoothed_group_mean"}:
        return []
    ...
    if regressor_type == "conditional_linear_blend":
        resolved = _resolve_extra_columns(
            dict(config["default_predictor"]),
            available_columns=available_columns,
        )
        resolved.extend(
            _resolve_extra_columns(
                dict(config["slice_predictor"]),
                available_columns=available_columns,
            )
        )
        return list(dict.fromkeys(resolved))
    if regressor_type in {"warm_start_last_target_blend", "recent_mean_delta"}:
        return _resolve_extra_columns(
            dict(config["base_predictor"]),
            available_columns=available_columns,
        )
    if regressor_type in {"fixed_prefix_residual", "normalized_prefix_residual"}:
        resolved = _resolve_extra_columns(
            dict(config["base_predictor"]),
            available_columns=available_columns,
        )
        ...
        resolved.extend(
            column
            for column in detect_feature_columns(list(available_columns))
            if column not in banned_feature_columns
        )
        return list(dict.fromkeys(resolved))
...
def _resolve_transformer_columns(
    config: dict[str, object],
    *,
    available_columns: list[str] | tuple[str, ...],
) -> list[str]:
    ...
    transformer_type = str(dict(transformer_config).get("type", "identity"))
    if transformer_type == "identity":
        return []
    if transformer_type == "causal_history":
        transformer_dict = dict(transformer_config)
        source_columns = transformer_dict.get("source_columns")
        banned_feature_columns = set(transformer_dict.get("banned_feature_columns", []))
        ...
        return [
            ...
            if str(column) in available_columns and str(column) not in banned_feature_columns
        ]
...
def resolve_required_columns(
    ...
    *,
    ...
    requested_columns: list[str] = [*CONTEXT_COLUMNS]
    requested_columns.extend(
        _resolve_transformer_columns(
            dict(config),
            available_columns=available_columns,
        )
    )
    ...
    if include_target and TARGET_COLUMN in available_columns:
        requested_columns.append(TARGET_COLUMN)
    if include_weight and WEIGHT_COLUMN in available_columns:
        requested_columns.append(WEIGHT_COLUMN)
    return list(dict.fromkeys(requested_columns))


def build_transformer(config: dict[str, object]):
    transformer_config = config.get("transformer")
    if transformer_config is None:
        return IdentityTransformer()

    transformer_dict = dict(transformer_config)
    transformer_type = str(transformer_dict.get("type", "identity"))
    if transformer_type == "identity":
        return IdentityTransformer()
    if transformer_type == "causal_history":
        return CausalHistoryTransformer(
            level_columns=list(transformer_dict.get("level_columns", ["code", "sub_category", "horizon"])),
            source_columns=(
                [str(column) for column in transformer_dict["source_columns"]]
                if transformer_dict.get("source_columns") is not None
                else None
            ),
            history_features=list(transformer_dict.get("history_features", ["last", "mean", "delta"])),
            banned_feature_columns=set(transformer_dict.get("banned_feature_columns", [])),
        )
...
def build_predictor(config: dict[str, object]):
    ...
    if regressor_type == "conditional_linear_blend":
        return ConditionalLinearBlendRegressor(
            default_predictor=build_predictor(dict(config["default_predictor"])),
            slice_predictor=build_predictor(dict(config["slice_predictor"])),
    ...
    if regressor_type == "normalized_prefix_residual":
        return NormalizedPrefixResidualCorrectionRegressor(
            base_predictor=build_predictor(dict(config["base_predictor"])),
            model_type=str(config["model_type"]),
            horizons=config.get("horizons"),
            sub_categories=config.get("sub_categories"),
            codes=config.get("codes"),
            residual_train_steps=int(config["residual_train_steps"]),
            oof_holdout_steps=int(config.get("oof_holdout_steps", 360)),
            oof_step_size=int(config.get("oof_step_size", 360)),
            oof_min_train_steps=int(config.get("oof_min_train_steps", 2000)),
            correction_scale=float(config["correction_scale"]),
            correction_clip_quantile=float(config["correction_clip_quantile"]),
            max_train_rows=int(config["max_train_rows"]),
            alpha=float(config.get("alpha", 10.0)),
